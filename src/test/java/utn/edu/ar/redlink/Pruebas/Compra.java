...
class Compra {
	...
	Cliente unCliente = new Cliente(41835967, "Mauro", 1134213697);
	...
	MedioDePago efectivo = new MedioDePago(0);
	...
	void ComprarConCupon() {
		unCliente.getMisCupones().add(unCupon);
		unCliente.agregarACarrito(unProducto, 3);
		assertEquals(294,unCliente.comprar(efectivo).getPrecioTotal());
	}
}
